...
var vm = new Vue({
    ...
    methods: {
            ...
            apps.axget(
                ...
                function(data) {
                    if (data) {
                        ...
                        //alert('123' + JSON.stringify(data) + data.score);
                        setTimeout(function () {
                          vm.shopsLevel(vm.selectShopInfo.score);
                        }, 1000);
                    }
                });
        },
        ...
        // 显示网点等级 -- 2018-05-08 @wanggang
        shopsLevel: function (score) {
          $("#half-demo ul").empty();
          if(score>0 && score <=5){
            for(var i=1;i<=score;i++){
              $("#half-demo ul").append("<li value=" + i + "><img></li>");
            }
            $("#half-demo ul li img").src;
            $("#half-demo ul li img").attr('src','./images/xingxing.png');
          }else if(score>5 && score<=10){
              for(var i=1;i<=(score-5);i++){
                $("#half-demo ul").append("<li value=" + i + "><img></li>");
              }
              $("#half-demo ul li img").src;
              $("#half-demo ul li img").attr('src','./images/zuanshi.png');
          }else {
              for(var i=1;i<=(score-10);i++){
                $("#half-demo ul").append("<li value=" + i + "><img></li>");
              }
              $("#half-demo ul li img").src;
              $("#half-demo ul li img").attr('src','./images/huangguan.png');
          }
        },
    },
});
