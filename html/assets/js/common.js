...
(function() {
    ...
    // 选择救援门店
    jumpUrl.choosehelp = function(pageParam) {
        apps.openWin('choosehelp', 'battery/choosehelp/choosehelp_win.html', pageParam)
    };
    ...
    // 支付 救援订单
    jumpUrl.afford = function(pageParam) {
        apps.openWin('rescueshop', 'battery/rescueshop/afford_win.html', pageParam)
    };
    ...
    // leaserecord
    // 续租记录
    jumpUrl.leaserecord = function() {
        apps.openWin('leaserecord', 'my/leaserecord/leaserecord_win.html')
    };
    // 我的会员
    ...
    // 电池寄存
    /*jumpUrl.Hosting = function () {
        apps.openWin('Hosting','battery/Hosting/Hosting_win.html');
    }*/
    ...
    //查看用户公告
    jumpUrl.announce = function(pageParam) {
        apps.openWin('announce', 'my/announce/announce_win.html', pageParam)
    };
    //查看相关问题
    jumpUrl.problem = function(pageParam) {
        apps.openWin('relateproblem', 'my/relateproblem/relateproblem_win.html', pageParam)
    };
    //查看相关问题详情
    jumpUrl.details = function(pageParam) {
        apps.openWin('details', 'my/relateproblem/details_win.html', pageParam)
    };
    // 收藏商品
    ...
    // 用户注册额登陆
    jumpUrl.leasing = function() {
        apps.openWin('leasing', 'sharetianniuuser/leasing/leasing.html')
    };
    ...
    //领取生日礼物页面
    jumpUrl.giftPage = function() {
        apps.openWin('birthGift_win', 'openmap/birthGift_win.html');
    };
    //修改电池型号
    jumpUrl.modifyBattery = function(pageParam) {
        apps.openWin('modifyBattery_win', 'my/mybatteries/modifyBattery_win.html',pageParam);
    };
    //更换电池型号订单
    jumpUrl.modifyBatteryList = function(pageParam) {
        apps.openWin('modifyBatteryList_win', 'my/modifyBatteryModelList/modifyBatteryList_win.html',pageParam);
    };
    //更换电池型号订单详情
    jumpUrl.modifyBatteryDetails = function(pageParam) {
        apps.openWin('modifyBatteryDetails_win', 'my/modifyBatteryModelList/modifyBatteryDetails_win.html',pageParam);
    };
})();
